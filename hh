...
var infoForAnimalType = function (aniT) {
    ...
    switch (aniT) {
      ...
      case a_zelvic_red:
            ...
            infoO.aniName = "The Red Zelvic";
            infoO.aniDesc = "";
            infoO.upgradeText = "The Red Owner";

            infoO.aniCol = "#FF0000";
            infoO.skinName = "RedZelvic";
            break;
        case a_zelvic_blue:
            infoO.aniName = "The Blue Owner";
            infoO.aniDesc = "";
            infoO.upgradeText = "The Blue Zelvic";
            infoO.aniCol = "rgb(0,0,255)";
            infoO.skinName = "snail";
            break;       
...
console.log(minimapScaleF_x,minimapScaleF_y)
  ...
  var desertW = msg.readUInt16();
  var desertH = msg.readUInt16();
  ...
  ctx_.fillRect(
   ...
   ctx_.fillStyle = "#c8b745";
  ctx_.globalAlpha = 0.5;
  var tF = minimapW / gameW;
  ctx_.fillRect(
    (gameW / 2 - desertW / 2) * tF,
    (gameH * 1.11132 - desertH) * tF,
    desertW * tF,
    desertH * tF
  );
...
if (KTestingModeON) {
    ...
    reg = "LOCAL";
    //let gameIp = "sandboxserver4.herokuapp.com"

  
  if(ACTIVATEOURGAMEMODE){addServerDef("FFA", "ahmetcan-channel-1.paiza-user-free.cloud/", reg,"80")}else{
addServerDef("LOCALHOST", "sandboxserver4.herokuapp.com", reg,"80"); 
...
//reg = "FFA";
 //  addServerDef("FFA", "146.148.81.224", reg);
   ...
   //addServerDef("Team Mode 1", "f23c-202-154-144-27.ap.ngrok.io", "80");
    ...
    case o_beach:
      {
        ...
        //draw dark grid
        //lGrid(-this.rectW / 2, -this.rectH / 2, this.rectW / 2, this.rectH / 2);
      }
      break;
    case o_biome_desert:
      {
...
Animal.prototype.animalInfo = function() {
  ...
  switch (this.animalType) {
    case a_snail:
      ...
      case a_zelvic_red :
      infoO.aniName = "Super OP Zelvic";
      infoO.aniDesc = "";
      infoO.upgradeText = "you are a op zelvic #foot";
